...
#define TSMessageViewMinimumPadding 22.0
...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        UILabel * crossLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 25, [UIScreen mainScreen].bounds.size.width-15 , 15)];
        [crossLabel setFont:[UIFont fontWithName:@"Avenir-Light" size:18]];
        [crossLabel setTextAlignment:NSTextAlignmentRight];
        [crossLabel setText:@"X"];
        [crossLabel setTextColor:[UIColor whiteColor]];
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    CGFloat posX = (self.iconImageView ? padding+[self imageSize]+20 : padding+10);
    
    self.titleLabel.frame = CGRectMake(posX,
                                       padding,
                                       screenWidth - padding - 15 - 15 - padding+[self imageSize] - 20,
                                       0.0);
    [self.titleLabel setBackgroundColor:[UIColor clearColor]];
